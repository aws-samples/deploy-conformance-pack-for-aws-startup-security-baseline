...
app = cdk.App()
rules_stack = Rules(app, "StartupSecurityBaselineRules",
...
pack_stack = Pack(app, "StartupSecurityBaselinePack", description="Startup Security Baseline Conformance Pack (uksb-1tupbocl2)").add_dependency(rules_stack)
